...
This source tree also contains an optional, cookie-backed Quark/UC WebDAV
kernel that runs independently alongside rclone. See
[the QuarkDav cookie kernel port notes](docs/QUARKDAV_COOKIE_KERNEL_PORT.md)
for its architecture, configuration, background-service behavior and license.
...
- QuarkDav cookie WebDAV kernel - derived from the supplied QuarkDav-Android project; the retained component is covered by AGPL-3.0. See [`quarkdav/NOTICE.md`](quarkdav/NOTICE.md).
