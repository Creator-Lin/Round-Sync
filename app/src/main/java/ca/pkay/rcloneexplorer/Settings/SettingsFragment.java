...
public class SettingsFragment extends Fragment {
    ...
    private Intent getImportIntent() {
        ...
        // MainActivity normally already exists below SettingsActivity. Reuse it instead
        // of stacking another MainActivity whose import action can later be replayed.
