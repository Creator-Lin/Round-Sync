...
public class ServeDialog extends DialogFragment {
    ...
    public interface Callback {
        void onServeOptionsSelected(int protocol, boolean allowRemoteAccess, boolean readOnly, String user, String password);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        readOnly = view.findViewById(R.id.checkbox_read_only);
        ...
        readOnly.setChecked(pref.getBoolean(getString(R.string.pref_choice_serve_dialog_read_only), false));
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("readOnly", readOnly.isChecked());
    ...
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        ...
        readOnly.setChecked(savedInstanceState.getBoolean("readOnly", false));
    ...
    private void sendCallback() {
        ...
        PreferenceManager.getDefaultSharedPreferences(context)
                ...
                .putBoolean(getString(R.string.pref_choice_serve_dialog_read_only), readOnly.isChecked())
                .apply();

        callback.onServeOptionsSelected(selectedProtocol, allowRemoteAccess.isChecked(), readOnly.isChecked(), user.getText().toString(), password.getText().toString());
    }
}
