...
class ProviderListFragment(private val mPreselection: String?) : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val providers = (mRclone?.providers ?: listOf()).toMutableList()
        providers.removeAll { it.name == QuarkDavRemote.PROVIDER_NAME }
        providers.add(Provider(QuarkDavRemote.PROVIDER_NAME).apply {
            description = getString(R.string.quarkdav_provider_description)
        })
